...
namespace DataLibraries
{
    public static class DataHelp
    {
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        public static IList<TResult> ToList<TResult>(this DataTable dt) where TResult : BaseModel, new()
        {
        ...
        /// <returns></returns>
        public static DataTable ToDataTable<TResult>(this IEnumerable<TResult> values) where TResult : BaseModel
        {
        ...
        public static string ArrayToString(this string[] arrays, string sign)
        {
